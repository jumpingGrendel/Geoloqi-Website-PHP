			...
			<td class="right">
				<div class="description">
					<select name="user_layer[<?=$layer->id?>]" class="field">
						<option value="0" <?=($layer->public==0)?'selected':''?>>Private</option>
						<option value="1" <?=($layer->public==1)?'selected':''?>>Public (<?=($layer->user_id == $this->users->id)?'editable':'non editable' ?>)</option>
					</select>
