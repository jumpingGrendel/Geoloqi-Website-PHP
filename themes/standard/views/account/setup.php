...
<div id="authorize" class="round"><div class="in">
	...
	<div style="padding-bottom: 20px;" class="settings settings-columns">
		...
		<tr>
			...
			<td class="right">
				<input id="password1" type="password" class="text" />
		...
		<tr>
			...
			<td class="right">
				<input id="password2" type="password" class="text" />
				<div id="password2-response"></div>
			</td>
		</tr>
		<tr>
			<td class="left"><div class="label small">Phone Number</div></td>
			<td><input id="phone_number" type="text" class="text" /></td>
		</tr>
		<tr>
			<td colspan="2" align="center">
				<input type="submit" name="accept" class="btn btn-ok" value="Finish" />
			</td>
		</tr>
		</tbody></table>		
